...
@Repository
@Suppress("FunctionNaming") // Spring Data JPA convention for nested properties uses underscores
interface FlashcardRepository : JpaRepository<FlashcardEntity, UUID> {
    ...
    @EntityGraph(attributePaths = ["vocabulary"])
    fun findByUser_UserId(userId: UUID, pageable: Pageable): Page<FlashcardEntity>
