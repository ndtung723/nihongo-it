...
class ChatController(
    ...
    ): String = chatService.getResponse(prompt)

    @GetMapping("/ask-ai-options")
    fun getResponseOptions(
        @RequestParam(value = "message") prompt: String,
    ): String = chatService.getResponseOptions(prompt)
    ...
    fun getListResponse(
        ...
        chatClient
            ...
            .user { u ->
                u
                    .text("Please provide the names of 3 best books for the given {category} and the {year}")
                    .param("category", category)
                    .param("year", year)
            }.call()
