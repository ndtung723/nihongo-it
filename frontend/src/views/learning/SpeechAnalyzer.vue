		...
		<div v-if="analysis" class="analysis-results">
			...
			<div class="word-analysis" v-if="analysis.words && analysis.words.length > 0">
				...
				<p class="analysis-note">
					<em
						>Ghi chú: Dấu câu và ký tự đặc biệt đã được loại bỏ để so sánh chính xác hơn. Nhấn vào
						từ đỏ để nghe phát âm chuẩn.</em
					>
				</p>
			</div>
				...
				<div class="score-breakdown">
					<div class="score-component intonation">
						...
						<div class="score-details">
							...
							<div class="score-metrics" v-else-if="analysis.pitchMean">
								...
								<span
									class="score-tip"
									v-if="analysis.samplePitchData && analysis.samplePitchData.length > 0"
								>
									(So sánh với mẫu)
								</span>
					...
					<div class="score-component clarity">
						...
						<div class="score-details">
							...
							<div class="score-metrics" v-if="analysis.f1Mean">
								...
								<span
									class="score-tip"
									v-if="analysis.sampleFormantData && analysis.sampleFormantData.length > 0"
								>
									(So sánh với mẫu)
								</span>
							...
							<div class="formant-tip" v-if="analysis.f1Mean && (analysis.clarityScore || 0) < 70">
								...
								<span v-else-if="analysis.f1Mean > 650"
									>Thử điều chỉnh vị trí lưỡi khi phát âm để cải thiện độ rõ</span
								>
					...
					<div class="score-component text-similarity" v-if="analysis.textScore !== undefined">
						...
						<div class="score-progress-container">
							<div
								class="score-progress-bar"
								:style="{ width: `${analysis.textScore}%`, backgroundColor: getScoreColor('text') }"
							></div>
						</div>
