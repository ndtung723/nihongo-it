									...
									<div class="message-content pa-2">
										<div class="d-flex justify-space-between align-center mb-0">
											<div class="japanese-text text-subtitle-1 font-weight-medium">
												...
												<span
													v-if="isTyping && i === visibleLineIndices[visibleLineIndices.length - 1]"
												>
												...
												>
													<span
														v-html="
															formatJapaneseWithHighlights(line.japanese, lineAnalysisResults[i])
														"
													></span>
												</span>
												<span
										...
										<div
											v-if="isUserLine(line) && activeLineIndex === i && isRecording && interimText"
						...
						<div class="feedback-summary-container">
							...
							<div class="d-flex flex-wrap gap-4">
								...
								<div
									...
									v-if="feedbackSummary.common_errors && feedbackSummary.common_errors.length > 0"
								>
								...
								<div
									...
									v-if="
										feedbackSummary.improvement_tips && feedbackSummary.improvement_tips.length > 0
									"
								>
									<h3 class="text-subtitle-1 font-weight-bold mb-2">
		...
		requestAnimationFrame(() => {
			...
			setTimeout(() => {
				...
				if (nextLine.speaker !== 'user') {
					const typingDuration = nextLine.japanese.length * typeSpeed.value + 200;
					setTimeout(() => {
						playAudio(nextLine);
					}, typingDuration);
				}
